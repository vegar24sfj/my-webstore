  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-lg text-gray-700 mb-6 text-center">
        Feel free to get in touch with us for any inquiries or support. You can contact us through the following channels:
      </p>
      ...
      <div className="space-y-8">
        ...
        <div className="p-6">
          ...
          <ul className="space-y-2 text-gray-700">
            <li>
              <strong>Email:</strong> <a href="mailto:support@example.com" className="text-blue-500 hover:underline">support@example.com</a>
            </li>
            <li>
              <strong>Phone:</strong> <a href="tel:+11234567890" className="text-blue-500 hover:underline">+1 (123) 456-7890</a>
            </li>
            <li>
